...
<form:form action="sponsor/register.do" modelAttribute="sponsor">
	...
	<fieldset>
		...
		<br/>
		<input type="submit" name="save" value='<spring:message code="sponsor.register"/>'/>
		
		<input type="button" name="cancel" value='<spring:message code="sponsor.cancel"/>' onclick="javascript: window.location.replace('welcome/index.do')"/>
</form:form>