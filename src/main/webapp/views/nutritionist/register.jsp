...
<form:form action="nutritionist/register.do" modelAttribute="nutritionist">
	...
	<fieldset>
		<legend align="left">
			<spring:message code="nutritionist.userAccount" />
		</legend>
		<form:label path="userAccount.username">
			<spring:message code="nutritionist.userAccount.username"/>
		</form:label>
		...
		<form:label path="userAccount.password">
			<spring:message code="nutritionist.userAccount.password"/>
		</form:label>
	...
	<fieldset>
		<legend align="left">
			<spring:message code="nutritionist.personalInfo" />
		</legend>
		...
		<br/>
		<input type="submit" name="save" value='<spring:message code="nutritionist.register"/>'/>
		
		<input type="button" name="cancel" value='<spring:message code="nutritionist.cancel"/>' onclick="javascript: window.location.replace('welcome/index.do')"/>
</form:form>